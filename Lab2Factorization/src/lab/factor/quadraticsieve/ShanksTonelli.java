...
import static lab.factor.quadraticsieve.MathUtils.isRootInQuadraticResidues;

/**
 * @author Artur Vasilov
 */
public final class ShanksTonelli {

    private ShanksTonelli() {
    }

    public static long[] calculate(long prime, long n) {
        long k, x;
        ...
        while (isRootInQuadraticResidues(BigInteger.valueOf(h * h - 4 * n), bigPrime));
