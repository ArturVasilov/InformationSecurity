...
namespace MD4Attack
{
	...
	int* MD4WangAttack::findCollisions()
	{

		random_device rd;
		mt19937_64 e2(rd());
		uniform_int_distribution<long long int> dist(llround(pow(2, 31) * -1), llround(pow(2, 31) - 1));
	...
	md4_again:
		...
		{
			/* D1 */
			Q0[2] = dist(e2) & ~0x00000040;
			Q1[2] = Q0[2] - 0xffffffc0;

			/* C1 */
			Q0[3] = (dist(e2) | 0x000000c0) & ~(0x00000800 | 0x02000000);
			Q0[3] |= (Q0[2] & 0x02000000);
			Q1[3] = Q0[3] - 0xfffffc80;

			/* B1 */
			Q0[4] = (dist(e2) | 0x00000040) & ~0x02000480;
			Q1[4] = Q0[4] - 0xfe000000;

			/* A2 */
			Q0[5] = (dist(e2) | 0x00000480) & ~(0x02000000 | 0x00002000);
			Q0[5] |= (Q0[4] & 0x00002000);
			Q1[5] = Q0[5];

			/* D2 */
			Q0[6] = (dist(e2) | 0x02000000) & ~(0x00002000 | 0x003c0000);
			...
			/* C2 */
			Q0[7] = (dist(e2) | 0x00100000) & ~(0x002c2000 | 0x00005000);
			...
			/* B2 */
			Q0[8] = (dist(e2) | 0x00003000) & ~(0x003c4000 | 0x00010000);
			...
			/* A3 */
			Q0[9] = (dist(e2) | 0x00207000) & ~(0x001d0000 | 0x02400000);
			...
			/* D3 */
			Q0[10] = (dist(e2) | 0x02307000) & ~(0x00490000 | 0x20000000);
			...
			/* C3 */
			Q0[11] = (dist(e2) | 0x20010000) & ~(0x02780000 | 0x80000000);
			...
			/* B3 */
			Q0[12] = (dist(e2) | 0x02300000) & ~(0xa0080000 | 0x00400000);
			...
			/* A4 */
			Q0[13] = (dist(e2) | 0x20000000) & ~(0x82400000 | 0x14000000);
			...
			/* D4 */
			Q0[14] = (dist(e2) | 0x94000000) & ~0x22400000;
			...
			/* C4 */
			Q0[15] = (dist(e2) | 0x02400000) & ~(0x34000000 | 0x00040000);
			...
			/* B4 */
			Q0[16] = (dist(e2) | 0x14000000) & ~0x20040000;
...
#define LOOP_11 100
		...
		for (i = 0; i < LOOP_11; i++)
		{
			Q0[1] = dist(e2) & ~(0x00000040 | 0x00000480);
